...
Tag::Tag(const QString& text, QHBoxLayout* layout, QWidget* parent) : QWidget(parent) {
    ...
    connect(removeButton, &QPushButton::clicked, this, &Tag::onRemoveButtonClicked);
...
void Tag::onRemoveButtonClicked() {
