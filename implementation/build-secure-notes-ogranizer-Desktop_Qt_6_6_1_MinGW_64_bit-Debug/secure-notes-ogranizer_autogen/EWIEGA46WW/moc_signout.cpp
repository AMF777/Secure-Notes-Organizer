...
#include "../../../secure-notes-ogranizer/signout.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSsignoutENDCLASS_t qt_meta_stringdata_CLASSsignoutENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 13),  // "switchWidgets"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 16),  // "onSignOutClicked"
        QT_MOC_LITERAL(40, 15)   // "onCancelClicked"
    },
    "signout",
    "switchWidgets",
    "",
...
void signout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (signout::*)();
            if (_t _q_method = &signout::switchWidgets; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
